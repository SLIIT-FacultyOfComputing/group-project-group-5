...
export const createRoutine = async (routine) => {
    try {
        const response = await api.post('/api/routines', routine);
        return response.data;
    } catch (error) {
...
export const fetchRoutines = async (memberId) => {
    try {
        const response = await api.get(`/api/routines/${memberId}`);
        return response.data;
    } catch (error) {
...
export const fetchRoutineDetails = async (routineId) => {
    try {
        const response = await api.get(`/api/routines/details/${routineId}`);
        return response.data;
    } catch (error) {
...
export const renameRoutine = async (routineId, name) => {
    try {
        const response = await api.put(`/api/routines/${routineId}/name`, { name });
        return response.data;
    } catch (error) {
...
export const addExerciseToRoutine = async (routineId, assignment) => {
    try {
        const response = await api.post(`/api/routines/${routineId}/exercises`, assignment);
        return response.data;
    } catch (error) {
...
export const removeExerciseFromRoutine = async (routineId, exerciseId) => {
    try {
        await api.delete(`/api/routines/${routineId}/exercises/${exerciseId}`);
    } catch (error) {
